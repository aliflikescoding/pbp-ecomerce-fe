...
const socials = [
  ...
  },
  {
    ...
    url: "#",
    description:
      "Watch styling guides, launch stories, and community spotlights.",
    icon: FaYoutube,
  },
];
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-lg text-neutral-content/80 max-w-2xl mx-auto leading-relaxed font-light">
            At Aurora & Co, we believe in building meaningful relationships.
            Join our distinguished community and discover a world where
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  ${
                    isHovered
                      ? "border-amber-400/50 shadow-2xl shadow-amber-500/20 scale-105"
                      : ""
                  }
                `}
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <div
                      ...
                      ${
                        isHovered
                          ? "border-amber-300/60 bg-amber-400/10 rotate-6"
                          : "rotate-0"
                      }
                      mb-6
                    `}
        ...
        <div className="text-center">
          <div className="inline-block backdrop-blur-xl bg-white/5 border border-white/10 px-12 py-10 max-w-2xl">
            ...
            <p className="text-neutral-content/70 mb-8 font-light leading-relaxed">
              Our distinguished team awaits your inquiry. Connect through your
              preferred channel, and experience the Aurora & Co difference.
            </p>
